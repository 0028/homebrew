...
class Scala < Formula
  ...
  bottle do
    cellar :any
    sha1 "bdc887ad3b39edb0ae2020a93564716cea6f6a72" => :mavericks
    sha1 "f625033db43b382d91866ab74109ad1389b7c53e" => :mountain_lion
    sha1 "ee0714d133ac3d60ed2a086c4df705b0b1bec1a4" => :lion
  end
