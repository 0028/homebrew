...
class Subversion < Formula
  ...
  bottle do
    revision 1
    sha1 "47e549b721f00955895e8a25d9cd6847192a39c0" => :mavericks
    sha1 "ec0a39fee2e5acb7678689a67dd0513fbadcf530" => :mountain_lion
    sha1 "4407fa65485fdbeea6c58b71bceea2e3448e3303" => :lion
  end
