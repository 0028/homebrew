...
class Libgcrypt < Formula
  ...
  bottle do
    cellar :any
    sha1 "aa6651a5ba3edf5ca543c2a56f61a3c18a84afc8" => :mavericks
    sha1 "f41d4fcc0fb02661a51727b3cc0602a48377fea4" => :mountain_lion
    sha1 "e540d60fb6338f96262dc89a069a32df3a8aba6a" => :lion
  end
