...
class Xulrunner < Formula
  ...
  bottle do
    cellar :any
    sha1 "914742f415a6668b2eaaf65f2c88e89b01c86068" => :mavericks
    sha1 "04cbd507ec2c7e9b532fb523e203ea0e5959a8e0" => :mountain_lion
    sha1 "62c4d98730d1546a963fc39ade6af117d8f66d99" => :lion
  end
