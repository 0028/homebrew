...
class Pyqt < Formula
  ...
  bottle do
    sha1 "9188cadbc092a3fdfa5bb3f416616bf0e00d2e59" => :mavericks
    sha1 "46c05bf4cc6dde0f183916a811dcd8630854c9cf" => :mountain_lion
    sha1 "a0777ceacaff6ae63ee65646b3039a56ee17eaf8" => :lion
  end
