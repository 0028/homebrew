...
class Gpm < Formula
  ...
  bottle do
    cellar :any
    sha1 "9bcbfacdf02925fa1fa2ea78bd6e1857827be70c" => :mavericks
    sha1 "5da46481c6a5ebf92176be63bf7c270d3622aca3" => :mountain_lion
    sha1 "733fd54e9f40525ccd3e87d5b27d39fd854aca48" => :lion
  end
