...
class Python < Formula
  ...
  bottle do
    revision 2
    sha1 "f918191beda92234da047348a1f8fe5325fbc233" => :mavericks
    sha1 "1c8fadc58b1105a2734ceb4ffa987e55a50f63ab" => :mountain_lion
    sha1 "274fe62f90d2d085d498e0d9b7019a4a6c87cef1" => :lion
  end
