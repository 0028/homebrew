...
class Glib < Formula
  ...
  bottle do
    revision 1
    sha1 "3a0b10f2135fbc862a0f5adf91b268f6343075ee" => :mavericks
    sha1 "ee77a9ba7cd66f28c228d00127653dde33c87ee1" => :mountain_lion
    sha1 "cbf75bd2253739c79688afcce46447454fa9b7f3" => :lion
  end
