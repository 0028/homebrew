...
class Lua < Formula
  ...
  bottle do
    cellar :any
    sha1 "a234696539ba906ee4201bf2616ddce40500f6bf" => :mavericks
    sha1 "56ee45acfa052e8a222e6a88b3afe08a2ddf8342" => :mountain_lion
    sha1 "04bbc085af4319c6305edf6059527bca3a10c15e" => :lion
  end
