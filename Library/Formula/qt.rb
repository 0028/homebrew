...
class Qt < Formula
  ...
  bottle do
    revision 5
    sha1 "9cae7090dede22bdcae67a49b426b3d0989900a6" => :mavericks
    sha1 "463d2d8b1598bb78c5d71eab6e2952dbdcadddb2" => :mountain_lion
    sha1 "2ced43c795eb7b725ef28ed1207f4c594b5e4c49" => :lion
  end
