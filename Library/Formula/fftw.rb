...
class Fftw < Formula
  ...
  bottle do
    cellar :any
    revision 1
    sha1 "ae0954e67136c697149d3900c55e1a624c28aa33" => :mavericks
    sha1 "e4611a41b3f02ab3f438a0f88014a74a6440801f" => :mountain_lion
    sha1 "6bc11f9a0565d82303f6417aed264fb7b9388e12" => :lion
  end
