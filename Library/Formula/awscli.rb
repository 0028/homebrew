...
class Awscli < Formula
  ...
  bottle do
    cellar :any
    sha1 "103506776d15dac9a2a1a26a69368a00f06ef8fe" => :mavericks
    sha1 "98c921aaba7967610755b4c13e2ad2b0cf225873" => :mountain_lion
    sha1 "69c8eda659630760b474ed1959030723d0bae267" => :lion
  end
