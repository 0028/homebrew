...
class Cgal < Formula
  ...
  bottle do
    sha1 "bec7591f42d5e8789dc09e5ceb4986a3e9617905" => :mavericks
    sha1 "d2495f582c15cc6d6aa466fc0b64e1cee836152f" => :mountain_lion
    sha1 "637d2629b04ee2d2545c47507799d2bc65abaddd" => :lion
  end
