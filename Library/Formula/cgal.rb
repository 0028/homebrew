...
class Cgal < Formula
  ...
  bottle do
    sha1 "7bad47195412985e19713fe926c795a6b36fae1f" => :mavericks
    sha1 "46f8a89481a1e8d063036efd6a8dc35cda5e7b68" => :mountain_lion
    sha1 "40007a2c88b0d94359897132009c3d740201db80" => :lion
  end
