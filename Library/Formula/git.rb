...
class Git < Formula
  ...
  bottle do
    revision 1
    sha1 "4b7afb33b3f641459eac293066a1a3690c0f06c3" => :mavericks
    sha1 "62f5196272938761a1723c8ff6b71c0210f4ecc8" => :mountain_lion
    sha1 "bd25a76af5588ca8249b5d2635b5e39df4bc7d7d" => :lion
  end
