...
class Curl < Formula
  ...
  bottle do
    cellar :any
    revision 1
    sha1 "ef2b9d486973dd08e339af1a92ba9d57e4056cd9" => :mavericks
    sha1 "38a570a9ee06899ec9ae86f45bfc556002aad69d" => :mountain_lion
    sha1 "78594b3ed066f25d97310480a722515ecf67e745" => :lion
  end
