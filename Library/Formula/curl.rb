...
class Curl < Formula
  ...
  bottle do
    cellar :any
    sha1 'c1655b1b04fbb931e848a7948ee68c7a5570ce1e' => :mavericks
    sha1 'fe9a1759fb0a1cbb1f66c5d325dd5aea4d2fde30' => :mountain_lion
    sha1 'b780f74c7894b595380724b4228721402db4a9ec' => :lion
  end
