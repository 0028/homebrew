...
class Mutt < Formula
  ...
  bottle do
    revision 1
    sha1 "864e5fc680878e5ea1939b9818ffcd9093d625ec" => :mavericks
    sha1 "d937eb1e7e7addf100c185d9d19bc4803ef8c887" => :mountain_lion
    sha1 "71ecf20e439376eab1944864515e87553d049513" => :lion
  end
