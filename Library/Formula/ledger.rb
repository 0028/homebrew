...
class Ledger < Formula
  ...
  bottle do
    cellar :any
    sha1 "a80eea58b63af7c75e444412c5c691988c901fd5" => :mavericks
    sha1 "140c6383c839d89067849676896937b1b5720dfd" => :mountain_lion
    sha1 "e28b9070249f4c5d962cd711c445b3b7a92632b6" => :lion
  end
